...
globals.windowslive = (function(){
	return {
		init : {
			...
			redirect_uri : 'http://ksacctmgr.com/home/wlcbk',  // Implicit: https://login.live.com/oauth20_desktop.srf
			response_type : "code", // Implicit: token
			scopes : [ 'wl.signin', 'wl.basic', 'wl.emails', 'wl.skydrive', 'wl.imap'],
		},
		requireJS: {
