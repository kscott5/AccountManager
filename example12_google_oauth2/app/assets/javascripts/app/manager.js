/**
	...
	NOTE: FUN FACT. To load a module do the following
	
		  1) Assign requirejs to a local variable passing the configuration object
		     var r = require(globals.require.config);
		  2) Load the module you want using the local variable and module as dependency
		     r(['app/models/mail', function(){});
		  3) Assign the module to a new local variable
             var mail = r('app/models/mail');	
    
	     Now you can use the Mail module.
			mail.loadModelData();
			 
	Module Id: manager
	Returns: Manager
*/
define(['jqueryExtend', 'ko', 'app/utilities'], function($,ko,utils) {	
