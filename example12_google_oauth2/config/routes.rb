...
AccountManager::Application.routes.draw do
  ...
  resources :home, only: [:index, :viewer]
  ...
  post ':library/mailbox/:name/:command' => 'home#mailbox'
  
  # Route to retrieve library IMAP mailbox message
  post ':library/:name/view/:messageid' => 'home#message'
  
  # Routes for library OAuth2 flow
  get 'windowslive/callback' => 'home#windowslive_callback'
  get 'googleapi/callback' => 'home#googleapi_callback'
